...
<div class="containter-fluid mobile-hidden" style="background:url('/img/img-main-recruit-magazine-back.png') repeat center;">
	<div class="row  sub-row pt-5 ">
		<div class="col-11" style="margin:0 auto;">
			<div class="col-6 wow bounceInLeft" data-wow-delay="0.5s"><a href="/support/interview.do"><img src="/img/img-main-recruit-magazine001.png"></a></div>
...
<!-- 					<div class="col-12 py-1">
					...
					<div class="col-12 py-1"><button type="button" class="col-12 btn" style="height:3rem;background-color:red;color:#fff;" onclick="goSubscribe();">신청하기</button></div>
				</div>
			</div>
		</div>
	</div>
...
<script>
	function goSubscribe(){		
		...
		if($("#subsmobile2").val() == '' || $("#subsmobile3").val() == '' || $('#subsname').val() == '' || $('#subsage').val() == ''){
