              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h3 class="under-line mx-1">항공사실무면접정보@</h3>
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="tabler" class="table table-striped table-bordered" style="width:100%;">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td>${list.idx}</td>
                            <td><a href="/manager/interview/view.do?idx=${list.idx}">${list.title}</a></td>
                            <%-- <td>${list.visit}</td> --%>
...
<script>
 	...
 	function goWrite(){
 		document.location.href="/manager/interview/write.do";
 	}
