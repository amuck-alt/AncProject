    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <form action="/manager/news/update.do" name="form" id="form" method="post" data-toggle="validator">          
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="title" class="control-label">설명</label>
...
<script> 
 	...
 	function deleteContent(idx){
		if(confirm("정말로 삭제하시겠습니까?") == true){
			location.href="/manager/news/delete.do?idx="+idx;	
		}else{
			return;
		}		
	}
