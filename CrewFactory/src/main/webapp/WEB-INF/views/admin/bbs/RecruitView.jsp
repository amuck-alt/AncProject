    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <form role="form" name="form" method="post" action="/manager/recruit/update.do" data-toggle="validator">          
              ...
              <div class="card">
                <div class="card-body">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <select class="form-control mr-2" name="section" id="section">
                          <option value="ko" <c:if test="${list.section eq 'ko' }">selected</c:if>>국내항공사</option>
                          <option value="os" <c:if test="${list.section eq 'os' }">selected</c:if>>외국항공사</option>
                        </select>
                        <select class="form-control mr-2 input-group-append" name="airline" id="airline">
                          <c:forEach items="${airline}" var="list">
                        	<option value="${list.code}" style="background-image:url('/docs/code/${list.path}');" <c:if test="${result.airline eq list.code }">selected</c:if>>${list.name}</option>
                          </c:forEach>
                        </select>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control mr-2" value="${result.steptitle}" name="steptitle" id="steptitle" placeholder="예:서류전형" data-error="제목을 입력하세요." required>
                        <input type="text" class="form-control input-group-append" value="${result.stepdetail}" name="stepdetail" id="stepdetail" placeholder="예:00월00일" data-error="제목을 입력하세요." required>
                      </div>
                      <div class="help-block with-errors text-danger"></div>
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="description" rows=4>${result.description}</textarea>
                      <div class="help-block with-errors text-danger"></div>
                    </div>
                    <div class="form-group">
