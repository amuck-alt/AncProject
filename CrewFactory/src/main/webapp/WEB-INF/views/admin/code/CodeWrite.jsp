    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <form action="/manager/code/insert.do" name="form" id="form" method="post" data-toggle="validator" enctype="multipart/form-data">          
              ...
              <div class="card">
                <div class="card-body">
                    <div class="form-group">
                		<label for="userid" class="control-label">아이콘 (가로 : 200px, 세로 : 100px)</label>
                		<div class="input-group my-4">
                		  <div><img src="/admin/images/no-icon.png" class="wrapper-tn" id="icon-img" width="150"></div>
                		  <div class="input-group-append mx-4">
                			<input type="file" name="path" id="icon" style="display:none;" required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                      	<input type="text" class="form-control" value="" name="code" id="code" placeholder="예 : ke" required>
                    ...
                    <div class="form-group">
                      <label for="editor" class="control-label">코드명(띄어쓰기없이 한글(영문)으로 입력)</label>
	                  	<input type="text" class="form-control" value="" name="name" id="name" placeholder="예 : 대한항공" required>
	                  <div class="help-block with-errors text-danger"></div>
                    </div>
                    <button type="submit" class="btn btn-primary mr-2">저장</button>
                    <a href="../code.do" class="btn btn-light">취소</a>
                </div>
              </div>
            </div>
          </div>	
