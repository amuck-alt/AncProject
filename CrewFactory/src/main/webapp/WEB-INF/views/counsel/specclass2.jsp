	...
	<div class="container-fluid my-5">
		<div class="row sub-row">
			<div class="col-12 text-center">
				<img src="/img/220908_sp_page_mo.jpg"  alt="플라이나스 객실 승무원 채용" id="mobile-100-percent">
			</div>
		</div>
	</div>
					...
					<div class="col-12 card">
						<div class="card-body">
							...
							<div class="form-group" style="padding:10px;">
		               		...
		               		<textarea class="form-control" name="memo" id="memo" placeholder="신청과목을 여기에 적어주세요. ex) 플라이나스 채용설명회 신청 " rows="3" maxlength="300"></textarea>
		                  	<div class="help-block with-errors text-danger"></div>
		               		</div>
               	</div>
               </div>
