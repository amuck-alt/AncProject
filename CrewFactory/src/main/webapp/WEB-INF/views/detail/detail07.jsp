...
<title><%= site_title %> - 외국항공사 수강생 모집 중!</title>
...
<body>
	...
	<div class="container-fluid  mobile-hidden" >
		<div class="row">
			<div class="col-12 text-center">
				<img src="/img/220908_d7_page_01.gif" style="width: 100%;" alt="class open" id="mobile-100-percent">
				<img src="/img/220908_d7_page_02.jpg" style="width: 100%;" alt="class open" id="mobile-100-percent">
			</div>
		</div>
	</div>
	<div class="container-fluid mobile-show">
		<div class="row">
			<div class="col-12">
					<img src="/img/220908_d7_page_01_mo.gif" alt="class open" id="mobile-100-percent">
	...
	<!-- <div class="container-fluid  mobile-hidden" >
		<div class="row">
			<div class="col-12 text-center">
				<img src="/img/detail_open_o01-1.gif" style="width: 100%;" alt="class open" id="mobile-100-percent" >
			</div>
		</div>
	</div>
	<div class="container-fluid mobile-show">
		<div class="row">
			<div class="col-12">
					<img src="/img/detail_open_o01-1_mo.gif" alt="class open" id="mobile-100-percent">
				</div>
			</div>
		</div> -->
	...
	<!-- <div class="container-fluid mobile-hidden">
		<div class="row">
			<div class="col-12">
					<img src="/img/detail_open_o02.jpg" alt="class open" id="mobile-100-percent" style="width:100%;">
					<img src="/img/detail_open_o02-2.jpg" alt="class open" id="mobile-100-percent" style="width:100%;">
					<img src="/img/detail_open_o02-3.jpg" alt="class open" id="mobile-100-percent" style="width:100%;">
				</div>
			</div>
		</div> -->
	...
	<!-- <div class="container-fluid mobile-show">
		<div class="row">
			<div class="col-12">
					<img src="/img/detail_open_mobile_o02.jpg" alt="class open" id="mobile-100-percent">
					<img src="/img/detail_open_mobile_o02-2.jpg" alt="class open" id="mobile-100-percent">
					<img src="/img/detail_open_mobile_o02-3.jpg" alt="class open" id="mobile-100-percent">
				</div>
			</div>
		</div> -->
			...
			<div class="col-8 my-3" id="mobile-100-percent" >
				<div class="swiper-container" id="spc-gallery-thumbs" >
					<div class="swiper-wrapper">
						<div class="swiper-slide text-center py-3 font-20" id="">채용설명회</div>
						<div class="swiper-slide text-center py-3 font-20" id="">자소서첨삭</div>
						<div class="swiper-slide text-center py-3 font-20" id="">채용대비반</div>
						<div class="swiper-slide text-center py-3 font-20" id="">전문가특강</div>
						<div class="swiper-slide text-center py-3 font-20" id="">스터디</div>
						<div class="swiper-slide text-center py-3 font-20" id="">합격자간담회</div>
					</div>
				</div>
			</div>
			<div class="col-2"></div>
