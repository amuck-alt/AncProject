			...
			<div class="card bg-light-gray">
				<div class="card-body">
                  ...
                  <div class="text-left pt-1 help-block with-errors text-danger"></div>                  
					...
					<div class="form-group">
						<div class="input-group">
							<input type="text" class="form-control" name="usernm" id="usernm" maxlength="10" placeholder="이름" data-error="이름과 나이을 입력하세요." required>
							<input type="text" class="ml-2 form-control input-group-append" name="age" id="age" maxlength="2" oninput="maxLengthCheck(this)" placeholder="나이" data-error="이름과 나이을 입력하세요." required>
                  </div>
                  <div class="text-left pt-1 help-block with-errors text-danger"></div>                  
					</div>
					<div class="form-group">
                  ...
                  <div class="input-group">
                  	<select class="form-control mr-2" id="member-mobile1" name="member-mobile1" style="height:3.75rem;">
                   	...
                   	<input type="text" class="form-control input-group-append mr-2" name="member-mobile2" id="member-mobile2" oninput="maxLengthCheck(this)"  data-error="연락처를 정확히 입력하세요." maxlength="4"  required>
                   	<input type="text" class="form-control input-group-append" name="member-mobile3" id="member-mobile3" oninput="maxLengthCheck(this)" data-error="연락처를 정확히 입력하세요."  maxlength="4" required>
                 </div>
