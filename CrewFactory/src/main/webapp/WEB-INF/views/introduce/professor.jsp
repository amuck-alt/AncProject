						...
						<div class="swiper-slide">
							<div class="col-7 pro-main-container rad-div-20 off-hide mobile-100-percent" style="position:relative; background:url('/img/pro-sign-bg.jpg') no-repeat left bottom;">
								...
								<div class="pro-title-container" style="position:relative; z-index:600;">
									...
									<%-- <span class="mx-2"><a href="javascript:viewModal('#modalNum${status.count}')"><img src="/img/ico-more-view-btn.png"></a></span> --%>
									</div>
...
<script>
	function viewModal(str, idx){
		var modal = str;
		var num = idx;
		var listHeight = $(num).height();
		var modalHeight = $(modal).height();
		var varHeight = listHeight + "px";

		$(modal).children(".modal-dialog").css("top", varHeight);	
		$(modal).show();
