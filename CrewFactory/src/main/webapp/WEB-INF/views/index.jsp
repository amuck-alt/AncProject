		...
		<div class="row">
			<div class="swiper-container" id="sw-main-visual">
				...
				<div class="swiper-wrapper" >
					...
					<!-- 플라이나스 객실 승무원 채용 -->
					<div class="swiper-slide off-hide" style="background: url('/img/220908_sp_banner_bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							<img src="/img/220908_sp_banner.png">
							<button class="more-view-btn font-16 bg-black" type="button" onclick="location.href='counsel/specclass2.do' " style="position: absolute; bottom: 16%; left: 15.3%;">자세히 보기</button>
						</div>
					</div>
					...
					<div class="swiper-slide off-hide" style="background: url('/img/220908_d7_banner_bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							...
							<button class="more-view-btn font-16 bg-black" type="button" onclick="location.href='detail/detail07.do' " style="position: absolute; bottom: 16%; left: 13%;">자세히 보기</button>
						</div>
					</div>
					
					<!-- ANC·크루팩토리 통합운영 -->
					<div class="swiper-slide off-hide" style="background: url('/img/220822_anccrew_d4_banner_bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							<img src="/img/220822_anccrew_d4_banner.png">
							<button class="more-view-btn font-16 bg-black font-white " type="button" onclick="location.href='detail/detail04.do' " style="position: absolute; bottom: 25%; left: 42%;">자세히 보기</button>
						</div>
					</div>
				
					<!-- 개강일정 - 대한항공 승무원 6인 정규과정 -->
					...
					<div class="swiper-slide off-hide" style="background: url('/img/220308_sp_banner_bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							...
							<button class="more-view-btn font-16 bg-black " type="button" onclick="location.href='counsel/specclass.do' " style="position: absolute; bottom: 17%; left: 17%;">자세히 보기</button>
						</div>
					</div>
									
				    <!-- 대한항공 2022년 채용동향 -->
					<div class="swiper-slide off-hide" style="background: url('/img/2020-main-visual-210319-bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							<img src="/img/2020-main-visual-210319.png">
							<button class="more-view-btn font-16 bg-black font-white" type="button" onclick="location.href='detail/detail01.do' " style="position: absolute; bottom: 12%; left: 41.5%;">자세히 보기</button>
						</div>
					</div>									
					...
					<!-- 중동항공사 합격자 간담회 -->
					<!-- <div class="swiper-slide off-hide" style="background: url('/img/220506_sp2_banner_bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							<img src="/img/220506_sp2_banner.png">
							<button class="more-view-btn font-16 bg-black font-white " type="button" onclick="location.href='detail/detail11.do' " style="position: absolute; bottom: 10%; left: 41.5%;">자세히 보기</button>
						</div>
					</div> -->										
										
					<!-- 인하공전 83명, 한서대 36명 합격! -->
					<div class="swiper-slide off-hide" style="background: url('/img/2020-main-visual-211104-bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							<img src="/img/2020-main-visual-211104.png">
							<button class="more-view-btn font-16 bg-black font-white " type="button" onclick="location.href='detail/detail09.do' " style="position: absolute; bottom: 12%; left: 42%;">자세히 보기</button>
						</div>
					</div>
					...
					<div class="swiper-slide off-hide" style="background: url('/img/2020-main-visual-210706-bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							...
							<button class="more-view-btn font-16 bg-black " type="button" onclick="location.href='support/alos.do?section=os&search=em' " style="position: absolute; bottom: 12%; left: 42%;">자세히 보기</button>
						</div>
					</div>
					
					<!-- 2022학년도 TOP6 - 전국 항공과 대학 석권 -->
					<div class="swiper-slide off-hide" style="background: url('/img/2020-main-visual-210217-bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							<img src="/img/2020-main-visual-210217.png">
							<button class="more-view-btn font-16 bg-black font-white " type="button" onclick="location.href='/counsel/online.do' " style="position: absolute; bottom: 8%; left: 39.7%;">상담신청 하러가기</button>
						</div>
					</div>
										
					<!-- 98.1% 최고 합격률 기록 -->
					<div class="swiper-slide off-hide" style="background: url('/img/2020-main-visual-210416-bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							<img src="/img/2020-main-visual-210416.png">
							<button class="more-view-btn font-16 bg-black " type="button" onclick="location.href='detail/detail03.do' " style="position: absolute; bottom: 15%; left: 13%;">자세히 보기</button>
						</div>
					</div>
					
					<!-- 합격생 간담회 -->
					<!-- <div class="swiper-slide off-hide" style="background: url('/img/2020-main-visual-211228-bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							<img src="/img/2020-main-visual-211228.png">
							<button class="more-view-btn font-16 bg-black font-white " type="button" onclick="location.href='/counsel/specclass2.do' " style="position: absolute; bottom: 10%; left: 41.5%;">자세히 보기</button>
						</div>
					</div> -->		
					...
					<div class="swiper-slide off-hide" style="background: url('/img/2020-main-visual-05-bg.jpg') no-repeat center;">
						<div class="cf-row off-hide" style="position: relative;">
							...
							<button class="more-view-btn font-16 bg-black" type="button" onclick="location.href='detail/detail02.do' " style="position: absolute; bottom: 20.4%; left: 7.3%;">자세히 보기</button>
						</div>
					</div>
					...
					<div class="swiper-slide" style="background-color: #e6f8ff;">
						<div class="cf-row" style="position: relative;">
							...
							<button class="more-view-btn font-16 bg-black" type="button" onclick="location.href='detail/detail06.do' " style="position: absolute; bottom: 15%; left: 42%;">자세히 보기</button>
						</div>
					</div>
				...
				<div class="swiper-wrapper">	
					...
					<div class="swiper-slide">						
						<a href='/counsel/specclass2.do'>
							<img src="/img/2020-mobilel-1016.jpg">	
						</a>
					</div>
					...
					<!-- 윈터스쿨 -->
					<div class="swiper-slide">						
						<a href='/counsel/specclass3.do'>
							<img src="/img/2020-mobilel-1023.jpg">	
						</a>
					</div>
