...
<div class="m-container border-bottom">
	<div class="m-row">
		<div class="col-12 px-2 py-3">
			...
			<div class="col-2"><a href="tel:02-2038-0065"><img src="/imgm/call-img-8282.png" width="25px" class="ml-2"></a></div>
		</div>
	</div>
</div>
<div class="m-container" id="mobile-menu" style="height:100%; display:none;">
	<div class="m-row">
		<div class="col-12 px-2 py-3 border-bottom" style="background:#1b2e5f;">
			...
			<div class="col-6 pr-2 text-right font-14 font-white"><a href="tel:02-2038-0065">02-2038-0065</a></div>
		</div>
		...
		<div class="col-12">
			<div class="swiper-container sw-main-visual">
				<div class="swiper-wrapper">
					...
					<!-- 플라이나스 객실 승무원 채용 --><div class="swiper-slide"><a href="/counsel/specclass2.do"><img src="/imgm/220908_sp_banner_mo.png" width="100%"></a></div>
					<!-- 외국항공사 정규과정 --><div class="swiper-slide"><a href="/detail/detail07.do"><img src="/imgm/220908_d7_banner_mo.png" width="100%"></a></div>
					<!-- ANC·크루팩토리 통합운영 --><div class="swiper-slide"><a href="/detail/detail04.do"><img src="/imgm/220822_anccrew_d4_banner_mo.png" width="100%"></a></div>
					
					<!-- 대한항공 6인 정규과정 --><div class="swiper-slide"><a href="/detail/open.do"><img src="/imgm/banner-img-001.png" width="100%"></a></div>
					...
					<!-- 중동항공사 합격자 간담회 --><!-- <div class="swiper-slide"><a href="/detail/detail11.do"><img src="/imgm/220506_sp2_banner_mo.png" width="100%"></a></div> -->
					<!-- 인하공전 83명, 한서대 36명 합격! --><div class="swiper-slide"><a href="/detail/detail09.do"><img src="/imgm/banner-img-211104.png" width="100%"></a></div>   
					...
					<!-- 2022학년도 TOP6 전국 항공과 대학 석권 --><div class="swiper-slide"><a href="/counsel/online.do"><img src="/imgm/banner-img-210217.png" width="100%"></a></div>
					<!-- 98.1% 최고 합격률 기록 --><div class="swiper-slide"><a href="/detail/detail03.do"><img src="/imgm/banner-img-210416.png" width="100%"></a></div>
					<!-- 합격생 간담회 --><!-- <div class="swiper-slide"><a href="/counsel/specclass2.do"><img src="/imgm/211228_mobile_banner.png" width="100%"></a></div> -->
					<!-- 대한항공 Day --><div class="swiper-slide"><a href="/detail/detail06.do"><img src="/imgm/banner-img-koreanairday.png" width="100%"></a></div>
			...
			<div class="col-8 py-3 float-left">
				<div class="scheduler-container">
					<ul>	
						...
						<li>국내항공사 평일반<span class="mx-2">:</span>10월 12일</li>
						<li>외국항공사 평일반<span class="mx-2">:</span>10월 12일</li>
						<li>국내항공사 주말반<span class="mx-2">:</span>10월 15일</li>
						<li>외국항공사 주말반<span class="mx-2">:</span>10월 15일</li>
						<li>국내항공사 주말반<span class="mx-2">:</span>10월 16일</li>
						<li>외국항공사 주말반<span class="mx-2">:</span>10월 16일</li>
...
<div class="m-container">
	<div class="m-row">
		<div class="col-12">
			<a href="/counsel/specclass2.do"><img src="/imgm/220914_mid_banner_mo.jpg" width="100%"></a>
		</div>
	</div>
</div>
		...
		<div class="col-12">
			...
			<div class="col-12 px-3 py-3 border-bottom border-top">
				...
				<div class="col-8 px-3">
					...
					<div class="col-12 mt-1 py-1 font-18 ">국내항공사 취업반</div>
			...
			<div class="col-12 px-3 py-3 border-bottom border-top">
				...
				<div class="col-8 px-3">
					...
					<div class="col-12 mt-1 py-1 font-18">외국항공사 취업반</div>
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="col-12 border rad-div-10 px-3 py-3">
							...
							<div class="col-8">
								<p class="py-1 font-12">10월 12일</p>
	...
	<div class="m-row">
		<div class="col-12">
			<div class="col-12 text-center">
				...
				<!-- <p class="mb-2">크루팩토리 <b>We Are Crew</b></p>
...
<div class="m-container py-5 bg-navy border-bottom">
	<div class="m-row text-center">
		<div class="col-6" style="border-right: 1px solid #474747">
			...
			<p class="font-bold font-white font-16 py-1 pb-2 px-4 ">02-2038-0065</p>
			<p class="font-10 font-gray px-1">주말/공휴일에도 상담이 가능합니다</p>
			<a href="tel:02-2038-0065"><button class="btn btn-primary" style="width: 100px;margin-top:25px; font-size:12px;">전화걸기</button></a>
		</div>
		<div class="col-6" style="border-right: 1px solid #474747">
			<p class="font-14 font-white px-2">카톡상담</p>
			<p class="font-bold font-white font-16 py-1 pb-2 px-4 "><img src="../img/sns-kakao-ico-5.png">크루팩토리</p>
...
<div class="col-12 bg-hotpink2" id="bottomMenu" style="margin:0 auto; position:fixed; z-index:2039; bottom:0px; width:100%;">
	<div class="col-12" style="position:absolute; bottom:0px; width:100%;">
		<div class="col-12 my-3 pr-3 text-right float-right">
			<a href="tel:02-2038-0065"><img src="/imgm/phone-icon.png" width="100px"></a>
		</div>
