...
public class AdminProfessorController {
	...
	@RequestMapping(value="/mng/pro/list.do", method=RequestMethod.GET)
	public String list (HttpServletRequest request, Model model) throws Exception {
		model.addAttribute("result", service.selectByAdmin());
		return "/mng/pro/ProList";
	}
	
	@RequestMapping(value="/mng/pro/view.do", method=RequestMethod.GET)
	public String view (@RequestParam(value="idx") int idx, Model model) throws Exception {
		...
		return "/mng/pro/ProView";
	}
	
	@RequestMapping(value="/mng/pro/write.do", method=RequestMethod.GET)
	public String write (Model model) throws Exception {
		return "/mng/pro/ProWrite";
	}
	
	@RequestMapping(value="/mng/pro/insert.do", method=RequestMethod.POST)
	public String insert(HttpServletRequest request, @RequestParam("thumbnail") MultipartFile mpf, Model model) throws Exception {
		...
		return "redirect:/mng/pro/list.do";
	}
	
	@RequestMapping(value="/mng/pro/update.do", method=RequestMethod.POST)
	...
	@RequestMapping(value="/mng/pro/delete.do", method=RequestMethod.GET)
