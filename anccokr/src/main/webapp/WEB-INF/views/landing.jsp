...
<div class="container-fluid wow fadeInUp">
	<div class="row landing pt-5">
		<div class="col-12 text-center mt-5 mobile-hidden">
			<p class="font-100 my-5 font-350rem font-ls-2">ANC승무원학원 <span class="font-700">대표강사진</span></p>
...
<div class="container-fluid my-5" style="background:url('/img/landing/main-map-bg.jpg') no-repeat top;">
	<div class="row sm-row py-5">
		<div class="col-12 text-center my-5">
			<p class="font-100 my-5 font-350rem font-ls-2">ANC승무원학원<span class="font-700">위치찾기</span></p>
		</div>
		<!--<div class="col-12 my-5">
		...
		<div class="col-12 mb-4">
			<div class="col-12">
				<ul class="col-12 bg-white" style="border-top:3px solid #000; border-bottom:3px solid #000;">
					...
					<li class="float-left mt-4 mb-2"><p class="font-500 font-20">ANC승무원학원 강남캠퍼스</p>
...
<div class="container-fluid" style="background:url('/img/landing/class-banner-bg-img.jpg') no-repeat top;">
	<div class="row landing">
		<div class="col-12 text-center my-5">
			<p class="font-100 my-5 font-300rem font-lh-40rem font-white font-ls-2">ANC승무원학원을 선택하는 이유는 <br>"<span class="font-700">합격</span>" 이라는 결과 때문입니다.</p>
		</div>
	</div>
...
<div class="container-fluid bg-light-gray">
	<div class="row main-row py-5">
		<div class="col-12 text-center my-5">
			...
			<p class="font-150rem py-3 font-gray">ANC승무원학원이 유명해진 이유는 합격이라는 결과 때문입니다.</p>
		</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="col-12 px-3" style="overflow: auto; width: 100%; height: 500px;">
					<p class="my-3">㈜ 에어라인네트워크센터 ANC승무원학원(이하 ‘학원’이라 함) 개인정보처리방침은 다음과 같은 내용을 담고 있습니다.</p>
					<br> 1. 개인정보의 처리 목적<br>
					<p class="mx-2">
					...
					<br> 9. 개인정보의 안전성 확보 조치 ('ANC승무원학원')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.<br>
					<p class="mx-2">
					...
					<br>
					<p class="mx-2">
						원칙적으로 ㈜백아 이용자의 개인정보를 타인 또는 타기업, 기관에 공개하지 않습니다.<br> 다만 아래의 경우에는 예외로 합니다.<br> ㈜백아를 통해 교육 도중 작성된 저작물에 대한 저작권 및 초상권 또는 컨텐츠(사진,동영상)는 합리적인 차원에서 ㈜에어라인네트워크센터에 귀속하여 활용할 수 있다.<br> 본인은 본인의 개인정보(이름, 생년월일, 전화번호, 이메일 등)를 ANC승무원학원에 제공하여 취업관련 서비스의 마케팅 활동(전화 통화 방식, 이메일 발송 방식, SMS방식 포함) 목적으로 제공, 활용되도록 함에 동의
						합니다.<br>
					</p>
				</div>
			</div>
