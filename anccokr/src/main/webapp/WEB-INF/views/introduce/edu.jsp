...
<title><%=site_title%>-ANC승무원학원특별혜택</title>
	...
	<div class="container-fluid " style="background-color: #eef4f4; height: 43.35rem; ">
		<div class="row sub-row">
			...
			<div class="col-6 py-5 px-3 mobile-100-percent">
				...
				<div class="font-50-m my-3 pb-2 font-bold">ANC승무원학원입니다.</div>
				<p class="font-16-m my-4">
					ANC승무원학원이 <b>합격률이 높은이유</b>는 가장 중요한 <span class="font-pink font-bold">원칙 3가지</span>를 고집하고 있습니다.
				</p>
			...
			<div class="col-12 my-5">
				<div class="py-5">
					...
					<div class="col-12 my-3">
						<p class="font-gray">
							기존의 승무원학원들은 10명이 넘는 수업인원으로 시간에 대비해서 소홀해 질 수 밖에 없는 커리큘럼으로 이루어져 있습니다. <br>그래서 ANC승무원학원의 모든 커리큘럼은 <span class="font-bold font-black">8명미만</span>의 클래스와 <span class="font-bold font-black">1:1과외</span>의 <span class="font-bold font-black">소수정예수업</span>으로만 이루어져 있습니다.
						</p>
					</div>
