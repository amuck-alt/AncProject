...
<div class="floating-bar">
	<div class="col-12 text-center">
		<ul>
			...
			<li class="font-12 line-1-gray">
				<div class="col-12 pt-4 align-middle">
					<a href="tel:02-6959-1955"><img src="/img/ico-floating-bar-phone.png"></a>
					<p class="py-2">
						대표번호 <br>02-6959-1955
					</p>
				</div>
			</li>
			<li class="font-12 line-1-gray">
			...
			<li class="font-12 line-1-gray">
				<div class="col-12 pt-4 align-middle">
					<a href="http://www.crewgo3.com/index.asp?OV_REFFER=https://www.google.com/"><img src="/img/ico-floating-bar-go3.png"></a>
					<p class="py-2">
						항공운항과<br>입시학원
					</p>
				</div>
			...
			<li class="font-12 line-1-gray">
				<div class="col-12 pt-4 align-middle">
					<a href="http://www.crew-op.com/index.asp"><img src="/img/ico-floating-bar-tour.png"></a>
					<p class="py-2">
						여행사<br>관광통역사<br>취업학원
					</p>
				</div>
			</li>
		</ul>
...
<div class="right-floating-bar mobile-hidden">
	<div class="col-12">
		<ul>
			...
			<li class="bg-navy" style="height: 50px;">
			...
			<li class="border bg-white mt-2 off-hide">
				<div class="col-12 align-middle text-center">
					<a href="" data-toggle="modal" data-target="#coronaModal">
