...
<div class="container-fluid-m">
	<div class="row-m no-margin-x">
		<div class="col-12 my-3" style="padding-left:10px;">
			<div class="col-6 font-18"><strong>ANC승무원학원 커리큘럼</strong></div>
			<div class="col-6 py-1 px-1"></div>
		</div>
		<div class="col-12">
...
<div class="container-fluid py-5" style="width:100%; height: 100%; background: url('../img/wis-bg3.png') no-repeat center;">
	<div class="row main-row text-center">
		<div class="col-6 off-hide" style="border-right: 1px solid #474747">
			...
			<p class="font-18 font-pink py-1 pb-2 px-3 ">02-6959-1955</p>
    ...
    <div class="col-12 pt-5 pb-3">
      ...
      <div class="col-12">
        ...
        <div class="col-12">
        	...
        	<div class="col-12">  
	          <ul class="px-3">
	            <li class="font-gray font-10">서울특별시 강남구 논현동 18-4 성일빌딩 1F, 2F ANC승무원학원</li>
	          </ul>
	          <ul class="px-3">
	            <li class="font-gray font-10"><span>tel. 02-6959-1955</span><span class="mx-4">fax. 02-512-1467</span><a href="/detail/fee1.do" target="_blank" class="font-gray">수강료안내</a></li>
	          </ul>
	        </div>
	        <div class="col-12 mt-2 px-3">
        ...
        <div class="col-12 px-3 mt-4 font-white">Copyright ⓒ  에어라인네트워크센터(주), All rights reserved.</div>  
      </div>
    </div>
  </div>
</div>
