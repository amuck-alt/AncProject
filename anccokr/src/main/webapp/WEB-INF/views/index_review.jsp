...
<!-- 중간배너/학원과외 PC -->
<div class="containter-fluid bg-pass21" style="background: url('/img/221017_mid_banner_bg.png') no-repeat center;">
	<div class="row sub-row text-center">
		<div class="col-12"> <a href="/counsel/specclass2.do">
			<img src="/img/221017_mid_banner.png" class="mobile-100-percent"></a>
		</div>
	</div>
</div>
