...
<%@ include file = "../include/floating-left.jsp" %>
	...
	<div style="text-align: center;">
		<img src="/img/detail_1023_01_mobile.jpg" alt="윈터스쿨" id="mobile-100-percent"class="mobile-show">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail_1023_02_mobile.gif" alt="윈터스쿨" id="mobile-100-percent"class="mobile-show">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail_1023_03_mobile_01.jpg" alt="윈터스쿨" id="mobile-100-percent"class="mobile-show">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail_1023_03_mobile.jpg" alt="윈터스쿨" id="mobile-100-percent"class="mobile-show">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail_1023_04_mobile.jpg" alt="윈터스쿨" id="mobile-100-percent"class="mobile-show">
	</div>
	...
	<div style="text-align: center;">
		<img src="/img/detail_1023_01.jpg" alt="윈터스쿨" id="mobile-100-percent" class="mobile-hidden" style="width:100%;">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail_1023_02.gif" alt="윈터스쿨" id="mobile-100-percent" class="mobile-hidden" style="width:100%;">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail_1023_03_01.jpg" alt="윈터스쿨" id="mobile-100-percent" class="mobile-hidden" style="width:100%;">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail_1023_03.jpg" alt="윈터스쿨" id="mobile-100-percent" class="mobile-hidden" style="width:100%;">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail_1023_04.jpg" alt="윈터스쿨" id="mobile-100-percent" class="mobile-hidden" style="width:100%;">
	</div>
	-->
...
<div class="container-fluid my-5">
	<div class="row sub-row">
		<div class="col-12" style="text-align: center;">
			<img src="/img/210624_spclass_01.jpg" class="mobile-100-percent">
...
<div class="container-fluid  mobile-hidden" >
		<div class="row">
			<div class="col-12 text-center">
				<img src="/img/detail_aero_k01.jpg" style="width: 100%;" alt="class open" id="mobile-100-percent" >
			</div>
		</div>
	</div>
	<div class="container-fluid mobile-show">
		<div class="row">
			<div class="col-12">
					<img src="/img/detail_aero_k01_mo.jpg" alt="class open" id="mobile-100-percent">
				</div>
			</div>
		</div>
...
<div class="container-fluid">
	<div class="row sub2-row">
		<div class="col-12">
			...
			<input type="hidden" name="reurl" value="specclass3.do"/>
					...
					<div class="col-12 card">
						<div class="card-body">
							...
							<div class="form-group">
		               		...
		               		<textarea class="form-control" name="memo" id="memo" placeholder="신청과목을 여기에 적어주세요 ex)승무원 채용설명회" rows="3" maxlength="300"></textarea>
		                  	<div class="help-block with-errors text-danger"></div>
		               </div>
               	</div>
               </div>
...
$(document).ready(function() {
 	...
 	if(data == "ok"){
 		alert("특강신청이 완료되었습니다.");
 		location.href="/counsel/specclass3.do";
 	}
});
