...
<%@ include file = "../include/floating-left.jsp" %>
	...
	<!-- <div style="text-align: center;">
		<img src="/img/220707_sp2.jpg" alt="2023학년도 입시박람회" id="mobile-100-percent" class="mobile-hidden" style="width:100%;">
	</div> -->


	<!-- 모바일  -->
	<!-- <div style="text-align: center;">
		<img src="/img/220707_sp2_mo.jpg" alt="2023학년도 입시박람회" id="mobile-100-percent"class="mobile-show">
	</div> -->
	...
	<div class="row sub2-row site-map-row mt-5 mb-4">
		<div class="col-12">
		  <div class="col-12 mb-1">
		    <h1>특강신청(2023 대한항공 6회 퍼펙트 과정)</h1>
		  </div>
		  <div class="col-12 py-2 line-2-black" style="width:200px; margin:0 auto;"></div>
		  <div class="col-12 font-20 my-3"></div>
		  <div class="col-12 py-2">ANC승무원학원의 높은 합격률은 지금까지 소수정원제 원칙으로 그룹과외 수업을 고집한 결과입니다.</div>
		</div>
	</div>
</div>
					...
					<div class="my-2 font-bold font-18">개인정보입력</div>
						...
						<div class="card-body">
							<div class="form-group">
		                      ...
		                      <input type="text" class="form-control" name="name" id="name" maxlength="20" placeholder="이름" onkeyup="onlyKorean('name')" data-error="이름을 정확히 입력하세요" required>
					...
					<div class="col-12 card">
						<div class="card-body">
							...
							<div class="form-group" style="padding:10px;">
		               		...
		               		<textarea class="form-control" name="memo" id="memo" placeholder="신청과목을 여기에 적어주세요. ex) 대한항공 6회 퍼펙트 과정 " rows="3" maxlength="300"></textarea>
		                  	<div class="help-block with-errors text-danger"></div>
		               		</div>
               	</div>
               </div>
