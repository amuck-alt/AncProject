...
public class AdminWaveController {
	...
	@RequestMapping(value="/mng/blog/Wave.do", method=RequestMethod.GET)
	public String init(@RequestParam("section") String section, Model model) throws Exception {
		...
		return "/mng/blog/WaveList";
	}
	
	@RequestMapping(value="/mng/blog/WaveWrite.do", method=RequestMethod.GET)
	public String write(Model model) throws Exception {
		return "/mng/blog/WaveWrite";
	}
	

	@RequestMapping("/mng/blog/WaveInsert.do")
	...
	@RequestMapping(value="/mng/blog/WaveView.do", method=RequestMethod.GET)
	public String view(@RequestParam(value="idx") int idx, Model model) throws Exception {
		model.addAttribute("result", service.view(idx) );
		return "/mng/blog/WaveView"; 
	} 
	
	@RequestMapping("/mng/blog/WaveUpdate.do")
	...
	@RequestMapping(value="/mng/blog/WaveDelete.do", method=RequestMethod.GET)
	public String delete(@RequestParam(value="idx") int idx) throws Exception {
		service.delete(idx);
		return "redirect:/mng/blog/Wave.do";
	}
}
