...
public class AdminFaqController {
	...
	@RequestMapping(value="/mng/faq.do", method=RequestMethod.GET)
	...
	@RequestMapping(value="/mng/faq/write.do", method=RequestMethod.GET)
	public String write(Model model) throws Exception {
		return "/mng/bbs/FaqWrite";
	}
	
	@RequestMapping(value="/mng/faq/insert.do", method=RequestMethod.POST)
	public String insert(@ModelAttribute("@form") FaqDomain domain) throws Exception {
		service.insert(domain);
		return "redirect:/mng/faq";
	}
	
	@RequestMapping(value="/mng/faq/view.do", method=RequestMethod.GET)
