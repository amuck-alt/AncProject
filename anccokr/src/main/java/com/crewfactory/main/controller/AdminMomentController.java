...
public class AdminMomentController {
	...
	@RequestMapping(value="/mng/blog/Moment.do", method=RequestMethod.GET)
	public String init(@RequestParam("section") String section, Model model) throws Exception {
		...
		return "/mng/blog/MomentList";
	}
	
	@RequestMapping(value="/mng/blog/MomentWrite.do", method=RequestMethod.GET)
	public String write(Model model) throws Exception {
		return "/mng/blog/MomentWrite";
	}
	

	@RequestMapping("/mng/blog/MomentInsert.do") 
	...
	@RequestMapping(value="/mng/blog/MomentView.do", method=RequestMethod.GET)
	public String view(@RequestParam(value="idx") int idx, Model model) throws Exception {
		model.addAttribute("result", service.view(idx) );
		return "/mng/blog/MomentView";
	}
	
	@RequestMapping("/mng/blog/MomentUpdate.do")
	...
	@RequestMapping(value="/mng/blog/MomentDelete.do", method=RequestMethod.GET)
	public String delete(@RequestParam(value="idx") int idx) throws Exception {
		service.delete(idx);
		return "redirect:/mng/blog/Moment.do";
	}
