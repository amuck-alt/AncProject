...
public class AdminBlogController {
	...
	@RequestMapping(value="/mng/blog/WeAre.do", method=RequestMethod.GET)
	public String init(@RequestParam("section") String section, Model model) throws Exception {
		...
		return "/mng/blog/WeAreList";
	}	
	
	@RequestMapping(value="/mng/blog/WeAreWrite.do", method=RequestMethod.GET)
	public String write(Model model) throws Exception {
		return "/mng/blog/WeAreWrite";
	}
	

	@RequestMapping("/mng/blog/WeAreInsert.do") 
	public String insert(HttpServletRequest request, @RequestParam("thumbnail") MultipartFile mpf, Model model) throws Exception {
		...
		return "redirect:/mng/ok.do?home=&reurl="+reurl+"&section="+section+"&msg=succeed";
	}
	
	@RequestMapping(value="/mng/blog/WeAreView.do", method=RequestMethod.GET)
	public String view(@RequestParam(value="idx") int idx, Model model) throws Exception {
		...
		return "/mng/blog/WeAreView";
	}
	
	@RequestMapping("/mng/blog/WeAreUpdate.do")
	...
	@RequestMapping(value="/mng/blog/WeAreDelete.do", method=RequestMethod.GET)
	public String delete(@RequestParam(value="idx") int idx) throws Exception {
		service.delete(idx);
		return "redirect:/mng/blog/WeAre.do?section=blog";
	}
}
