...
public class AdminRecruitController {
	...
	@RequestMapping(value="/mng/recruit.do", method=RequestMethod.GET)
	public String init(HttpServletRequest request, Model model) throws Exception {
		...
		return "/mng/bbs/RecruitList";
	}
	
	@RequestMapping(value="/mng/recruit/write.do", method=RequestMethod.GET)
	public String write(@RequestParam(value="section") String section, Model model) throws Exception {
		...
		return "/mng/bbs/RecruitWrite";
	}
	
	@RequestMapping(value="/mng/recruit/insert.do", method=RequestMethod.POST)
	public String insert(@ModelAttribute("@form") RecruitDomain rd) throws Exception {
		service.insert(rd);
		return "redirect:/mng/recruit.do";
	}
	
	@RequestMapping(value="/mng/recruit/view.do", method=RequestMethod.GET)
	public String view(@RequestParam(value="idx") int idx, Model model) throws Exception {
		...
		return "/mng/bbs/RecruitView";
	}
	
	@RequestMapping(value="/mng/recruit/update.do", method=RequestMethod.POST)
	public String memupdate(@ModelAttribute("@form") RecruitDomain domain) throws Exception {
		service.update(domain);
		return "redirect:/mng/recruit.do";
	}
	
	@RequestMapping(value="/mng/recruit/delete.do", method=RequestMethod.GET)
